...
Due to the size of the experimental datasets evaluation of macroscopic \pKa{} prediction carried more weight in assessing performance of computational predictions, although microscopic \pKa{} evaluation can provide much more in depth analysis and can be more informative about capturing reasons for failure.


%%%
\subsection{Suggestions for future challenge design and evaluation of \pKa{} predictions}

When the experimental data is in the form of macroscopic \pKa{} values, the best way to evaluate computational predictions is in the level of predicted macroscopic \pKa{}s. Microscopic \pKa{} predictions can be converted to macroscopic \pKa{} predictions.
...
Capture computing costs in terms of average compute hours per molecule

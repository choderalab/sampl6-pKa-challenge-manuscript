...
Acid dissociation constant (\pKa{}) predictions is a prerequisite for predicting many other properties of small molecules such as protein-ligand binding affinity, distribution coefficient (\logD{}), and solubility due to the necessity of predicting relevant protonation states and their free energy penalty of such states. Therefore, accurate computational \pKa{} prediction methods are required for computer-aided drug design.
